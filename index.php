	...
	<div class="container-fluid">
		<div class="container">
			<div class="row m-3 text-center">
				<div class="col-lg-12">
					<h1 class="box-title">Multilevel Marketing</h1>
				</div>
			</div>
			<div  class="row justify-content-center">
				<div class="col-lg-6">
				<button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#exampleModalCenter" >Daftar Anggota</button>	
				</div>
				<div class="col-lg-6">
      ...
      <form method="POST" id="ins_rec">
	      <div class="modal-body">
			  	<div class="form-group">
					...
					<input type="text" name="username" class="form-control" placeholder="Nama Anggota">
					<span class="error-msg" id="msg_1"></span>
			  	</div>
			  	<div class="form-group">
					<label><b>Alamat</b></label>
					<input type="text" name="alamat" class="form-control" placeholder="Jalan Gatot Subroto No.2">
					<span class="error-msg" id="msg_2"></span>
			  	</div>
				<div class="form-group">
					<label><b>Pilih Nama Upline</b></label>
					<select class="custom-select" name="namaupline" id="namaupline">

					<option value="" selected>Choose...</option>

				 <?php 

						$db = mysqli_connect("localhost","root","","search_mlm");
						...
						$records = mysqli_query($db, "SELECT u_name From user WHERE  sudah_upline = 0");  // Use select query here 

						while($data = mysqli_fetch_array($records))
						{
							echo "<option value='". $data['u_name'] ."'>" .$data['u_name'] ."</option>";  // displaying data in option menu
						
							// $username2 = $data["u_name"];
							// echo $username2;
							// $sql2 = "UPDATE user SET sudah_upline=1 WHERE u_name='$username2'";
				...
				<div class="form-group">
					<label><b>Pilih Nama Downline 2 x</b></label>
					<input type="date" name="bod" class="form-control">
					<span class="error-msg" id="msg_4"></span>
			  	</div>
				<div class="form-group">
				<input type="text" name="nomortelepon" class="form-control" placeholder="081218605405">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" id="close_click" data-dismiss="modal">Tutup</button>
...
<div class="modal fade" id="updateModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateModalCenterTitle">Ubah Rekaman</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
		  	...
		  	<div class="form-group">
				<label><b>Alamat</b></label>
				<input type="text" class="form-control" name="alamat" id="upd_2" placeholder="Jalan Gatot Subroto No. 2">
				<span class="error-msg" id="umsg_2"></span>
		  	</div>
			<div class="form-group">
				<label><b>Pilih Nama Upline</b></label>
				<select class="custom-select" id="upd_3" name="namaupline">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nomortelepon" id="upd_5" placeholder="081218605405">
	...
	$(document).on("click", "button.editdata", function(){
		...
		$.getJSON("updateprocess.php", {checkid : check_id}, function(json){
			if(json.status == 0){
				...
				$('#upd_2').val(json.alamat);
				$('#upd_3').val(json.namaupline);
				$('#upd_4').val(json.bod);
				$('#upd_7').val(check_id);
				$('#upd_5').val(json.nomortelepon);
				// if(json.gender == 'Male'){
